Refinery::Menus.configure do |config|
  ...
  # config.menu_resources = {:refinery_page=>{:klass=>"Refinery::Page", :title_attr=>"title", :scope=>#<Proc:0x00000002d1b508@/home/moin/workspace/aidctv/refinerycms-menus/lib/refinery/menus/configuration.rb:19>}, :refinery_resource=>{:klass=>"Refinery::Resource", :title_attr=>"file_name"}} 
end
